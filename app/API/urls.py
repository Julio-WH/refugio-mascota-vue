...
from app.API.view.view_apiview import ListMascotas, DetalleMascota, MascotaPersonaList, ListVacunas, ListPersonas
...
urlpatterns = [
    ...
    #apiview#
    url(r'^apiview/$', csrf_exempt(ListMascotas.as_view()), name='apiview_mascota'),
    ...
    url(r'^apiview/vacunas$', ListVacunas.as_view(), name='apiview_mascota_vacunas'),
    url(r'^apiview/personas$', ListPersonas.as_view(), name='apiview_mascota_personas'),
    #generic#
